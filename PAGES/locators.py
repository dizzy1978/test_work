...
class SearchResultsPageLocators:
    SEARCH_RESULT_PAGE_MARK = (By.XPATH, "//div[@class='search_results']")
    ...
    SEARCH_RELEASE = (By.XPATH, "//div[@class='element most_wanted']//span[@class='year']")
    FILM_URL = "https://www.kinopoisk.ru/film/77331/"


class FilmPageLocators:
    FILM_URL = "https://www.kinopoisk.ru/film/77331/"
    FILM_TITLE = (By.XPATH, "//h1/span")
    FILM_RATING = (By.XPATH, "//span[contains(@class, 'film-rating-value')]/span[contains(@class, 'styles_rating')]")
    ...
    REVIEWS_BLOCK = (By.XPATH, "//ul[@class='resp_type']")
